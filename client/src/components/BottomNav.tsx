...
export default function BottomNav({ user }: BottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-blue-500/10 via-cyan-500/5 to-transparent backdrop-blur-xl shadow-[0_-10px_40px_-10px_rgba(59,130,246,0.3)] z-50">
