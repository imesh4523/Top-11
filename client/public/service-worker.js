const CACHE_NAME = '3xbet-v2'; // Increment version to force cache refresh
const STATIC_CACHE = '3xbet-static-v2';
const DYNAMIC_CACHE = '3xbet-dynamic-v2';
...
self.addEventListener('fetch', (event) => {
  ...
  // Network-first for everything else (HTML, JS, CSS) to ensure fresh content
  event.respondWith(
    fetch(request)
      .then((response) => {
